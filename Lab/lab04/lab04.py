def divide(quotients, divisors):
    ...
    """
    return {keys:[values for values in divisors if values%keys==0] for keys in quotients}
...
def closer_city(lat, lon, city_a, city_b):
    ...
    distance_a=distance(coordinate,city_a)
    distance_b=distance(coordinate,city_b)
